...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _core_service_widget_event_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./core/service/widget-event.service */
    ...
    var getKeycloakInstance = function getKeycloakInstance() {
      return window && window['entando'] && window['entando'].keycloak && Object.assign(Object.assign({}, window['entando'].keycloak), {
        initialized: true
      }) || {
        initialized: false
      };
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(widgetEventService) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.keycloak = Object.assign(Object.assign({}, getKeycloakInstance()), {
            initialized: true
          });
          this.unsubscribeFromKeycloakEvent = this.widgetEventService.subscribeToWidgetEvent(_core_service_widget_event_service__WEBPACK_IMPORTED_MODULE_1__["EVENT_KEY"].KEYCLOAK_EVENT_TYPE, function () {
            _this.keycloak = Object.assign(Object.assign({}, getKeycloakInstance()), {
              initialized: true
            });
          });
        }
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_service_widget_event_service__WEBPACK_IMPORTED_MODULE_1__["WidgetEventService"]));
    };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 2,
      consts: [[4, "ngIf", "ngIfElse"], ["elseBlock", ""], [3, "cardName", "keycloak"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _card_card_card_component__WEBPACK_IMPORTED_MODULE_3__["CardComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
        ...
        return [{
          type: _core_service_widget_event_service__WEBPACK_IMPORTED_MODULE_1__["WidgetEventService"]
        }];
      }, {
        cardname: [{
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _card_card_card_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./card/card/card.component */
    "./src/app/card/card/card.component.ts");
    /* harmony import */


    var _core_interceptor_security_interceptor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./core/interceptor/security.interceptor */
    "./src/app/core/interceptor/security.interceptor.ts");
    /* harmony import */


    var _core_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./core/pipes/pipes.module */
    "./src/app/core/pipes/pipes.module.ts");
    /* harmony import */


    var _core_service_app_initializer_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./core/service/app-initializer.service */
    ...
    var AppModule = /*#__PURE__*/function () {
      ...
      _createClass(AppModule, [{
        ...
        value: function ngDoBootstrap() {
          var el = Object(_angular_elements__WEBPACK_IMPORTED_MODULE_2__["createCustomElement"])(_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [{
        ...
        useClass: _core_interceptor_security_interceptor__WEBPACK_IMPORTED_MODULE_7__["SecurityInterceptor"],
        multi: true
      }],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"], _core_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_8__["PipesModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateModule"].forRoot({
        defaultLanguage: 'en'
      })]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        ...
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"], _core_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_8__["PipesModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppCardCardCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_core_service_widget_event_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/core/service/widget-event.service */
    "./src/app/core/service/widget-event.service.ts");
    /* harmony import */
    ...
    var _core_pipes_credit_card_pipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../core/pipes/credit-card.pipe */
    "./src/app/core/pipes/credit-card.pipe.ts");

    function CardComponent_div_12_p_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CardComponent_div_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CardComponent_div_13_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    var CardComponent = /*#__PURE__*/function () {
      function CardComponent(cardService, widgetEventService) {
      ...
      _createClass(CardComponent, [{
        ...
        value: function ngOnInit() {
          ...
          var userID = this.keycloak.idTokenParsed.preferred_username;
          this.cardService.getSeedsCardByUserID(userID, this.cardName).subscribe(function (response) {
            _this2.seedCard = response;

            if (_this2.cardName === 'checking' && _this2.firstCall) {
              _this2.firstCall = false;
    ...
    CardComponent.ɵfac = function CardComponent_Factory(t) {
      return new (t || CardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_card_service__WEBPACK_IMPORTED_MODULE_3__["CardService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_core_service_widget_event_service__WEBPACK_IMPORTED_MODULE_1__["WidgetEventService"]));
    };
    ...
    CardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 14,
      vars: 9,
      consts: [[3, "click"], [1, "seeds-card"], [1, "seeds-card-header"], [1, "seeds-card-icon", 3, "src"], [1, "seeds-card-title"], [1, "seeds-card-value"], [1, "seeds-card-action"], [1, "fas", "fa-ellipsis-v"], ["class", "seeds-card-body", 4, "ngIf"], [4, "ngIf"], [1, "seeds-card-body"], [1, "seeds-card-balance"], [1, "seeds-card-balance-caption"], ["class", "seeds-card-balance-reward", 4, "ngIf"], [1, "seeds-card-balance-reward"], [1, "seeds-card-balance-reward-value"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CardComponent, [{
        ...
        return [{
          ...
          type: src_app_core_service_widget_event_service__WEBPACK_IMPORTED_MODULE_1__["WidgetEventService"]
        }];
      }, {
        cardName: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
  ...
  /***/
  function srcAppCardCardCardServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CardService = /*#__PURE__*/function () {
      ...
      _createClass(CardService, [{
        key: "getSeedscard",
        value: function getSeedscard() {
          var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          var id = params.id,
              options = params.options,
              cardname = params.cardname;
          var url = "".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"], "/banking/api/").concat(cardname, "s/").concat(id);
          return this.httpClient.get(url);
        }
      }, {
        key: "getSeedsCardByUserID",
        value: function getSeedsCardByUserID(userID, cardName) {
          var url = "".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].domainUrl, "/banking/api/").concat(cardName, "/user/").concat(userID);
          return this.httpClient.get(url);
        }
      }]);
    ...
    CardService.ɵfac = function CardService_Factory(t) {
      return new (t || CardService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
    };
  ...
  /***/
  function srcAppCoreI18nEnJson(module) {
  ...
  /***/
  function srcAppCoreI18nItJson(module) {
    module.exports = JSON.parse("{\"label\":{\"common\":{\"couldNotFetchData\":\"Unfortunately we could not get data for this user\",\"widgetName\":\"{{widgetNamePlaceholder}}\",\"name\":\"Name\",\"value\":\"Value\",\"loading\":\"Loading...\",\"missingId\":\"Please provide seedscard ID\",\"notAuthenticated\":\"Waiting for authorization...\",\"download\":\"Download file\",\"noCheckingAccount\":\"You don't have a {{cardName}} account\",\"rewardPoints\":\"Reward Points\",\"checking\":\"Checking\",\"savings\":\"Savings\",\"creditcard\":\"Credit Card\",\"balance\":\"Balance\"},\"entities\":{\"seedscard\":{\"id\":\"ID\",\"accountNumber\":\"entities.seedscard.accountNumber\",\"balance\":\"entities.seedscard.balance\",\"userId\":\"entities.seedscard.userId\"}}}}");
    /***/
  },
  ...
  /***/
  function srcAppCoreInterceptorSecurityInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var SecurityInterceptor = /*#__PURE__*/function () {
      ...
      _createClass(SecurityInterceptor, [{
        key: "getKeycloakToken",
        value: function getKeycloakToken() {
        ...
        value: function getDefaultOptions() {
          var token = this.getKeycloakToken();
          return {
        ...
        value: function intercept(request, next) {
          var headers = this.getDefaultOptions();
    ...
    SecurityInterceptor.ɵfac = function SecurityInterceptor_Factory(t) {
      return new (t || SecurityInterceptor)();
    };

    SecurityInterceptor.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: SecurityInterceptor,
      factory: SecurityInterceptor.ɵfac
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SecurityInterceptor, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
      }], null, null);
    })();
    /***/
  ...
  /***/
  function srcAppCorePipesCreditCardPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CreditCardPipe", function () {
    ...
    var CreditCardPipe = /*#__PURE__*/function () {
      function CreditCardPipe() {
        _classCallCheck(this, CreditCardPipe);
      }

      _createClass(CreditCardPipe, [{
        key: "transform",
    ...
    CreditCardPipe.ɵfac = function CreditCardPipe_Factory(t) {
      return new (t || CreditCardPipe)();
    };

    CreditCardPipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
      name: "creditCard",
      type: CreditCardPipe,
      pure: true
    });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CreditCardPipe, [{
  ...
  /***/
  function srcAppCorePipesPipesModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _credit_card_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./credit-card.pipe */
    "./src/app/core/pipes/credit-card.pipe.ts");
  ...
  /***/
  function srcAppCoreServiceAppInitializerServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AppInitializerService", function () {
    ...
    var _i18n_en_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../i18n/en.json */
    "./src/app/core/i18n/en.json");

    var _i18n_en_json__WEBPACK_IMPORTED_MODULE_1___namespace = /*#__PURE__*/__webpack_require__.t(
    /*! ../i18n/en.json */
    "./src/app/core/i18n/en.json", 1);
    /* harmony import */


    var _i18n_it_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../i18n/it.json */
    "./src/app/core/i18n/it.json");

    var _i18n_it_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(
    /*! ../i18n/it.json */
    "./src/app/core/i18n/it.json", 1);
    /* harmony import */
    ...
    var AppInitializerService = /*#__PURE__*/function () {
      function AppInitializerService(translate) {
        _classCallCheck(this, AppInitializerService);

        this.translate = translate;
      }

      _createClass(AppInitializerService, [{
        key: "initialize",
    ...
    AppInitializerService.ɵfac = function AppInitializerService_Factory(t) {
      return new (t || AppInitializerService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"]));
    };

    AppInitializerService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppInitializerService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
  ...
  /***/
  function srcAppCoreServiceWidgetEventServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EVENT_KEY", function () {
      return EVENT_KEY;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "WidgetEventService", function () {
    ...
    var WidgetEventService = /*#__PURE__*/function () {
      function WidgetEventService() {
        _classCallCheck(this, WidgetEventService);

        this.widgetEventToFSA = function (widgetEvent) {
      ...
      _createClass(WidgetEventService, [{
        key: "publishWidgetEvent",
        value: function publishWidgetEvent(eventId, payload) {
        ...
        key: "createWidgetEventPublisher",
        value: function createWidgetEventPublisher(eventId, payload) {
          this.publishWidgetEvent(eventId, payload);
        }
      }, {
        key: "subscribeToWidgetEvent",
        value: function subscribeToWidgetEvent(eventId, eventHandler) {
        ...
        key: "subscribeToWidgetEvents",
        value: function subscribeToWidgetEvents(widgetEvents, eventHandler) {
    ...
    WidgetEventService.ɵfac = function WidgetEventService_Factory(t) {
      return new (t || WidgetEventService)();
    };

    WidgetEventService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: WidgetEventService,
      factory: WidgetEventService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](WidgetEventService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Nathan\git\entando-samples\standard-demo\banking-plugin\ui\widgets\banking-widgets\dashboard-card-angular\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
